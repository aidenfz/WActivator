@echo off
title Windows 10 ALL version activator by Aidenfz&cls&echo ************************************&echo Supported products:&echo – Windows 10 Home&echo – Windows 10 Professional&echo – Windows 10 Enterprise, Enterprise LTSB&echo – Windows 10 Education&echo.&echo.&echo ************************************ &echo Windows 10 activation…
...
cscript //nologo c:\windows\system32\slmgr.vbs /ipk 6P99N-YF42M-TPGBG-9VMJP-YKHCF >nul
...
cscript //nologo c:\windows\system32\slmgr.vbs /ipk YTMG3-N6DKC-DKB77-7M9GH-8HVX7 >nul
cscript //nologo c:\windows\system32\slmgr.vbs /ipk VK7JG-NPHTM-C97JM-9MPGT-3V66T >nul
cscript //nologo c:\windows\system32\slmgr.vbs /ipk NPPR9-FWDCX-D2C8J-H872K-2YT43 >nul
cscript //nologo c:\windows\system32\slmgr.vbs /ipk 8N67H-M3CY9-QT7C4-2TR7M-TXYCV >nul
cscript //nologo c:\windows\system32\slmgr.vbs /ipk NKJFK-GPHP7-G8C3J-P6JXR-HQRJR >nul
cscript //nologo c:\windows\system32\slmgr.vbs /ipk 8DVY4-NV2MW-3CGTG-XCBDB-2PQFM >nul
echo ************************************ &echo.&echo.&set i=1
:server
if %i%==1 set KMS_Sev=zh.us.to
